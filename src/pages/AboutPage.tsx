      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                ...
                note: 'rising to 100,000+ in summer',
              },
              {
                stat: '22 km',
                label: 'Monitored coastline',
                note: 'beaches and marine zones',
              },
              {
                stat: '85%',
                label: 'Waste to landfill',
                note: 'before recycling programme launch',
              },
            ].map((item) => (
              <div
                key={item.label}
          ...
          <p className="text-gray-700 leading-relaxed text-center max-w-2xl mx-auto">
            Northern Corfu's environment faces pressures from mass seasonal
            tourism, agricultural runoff, inadequate waste infrastructure, and
            climate change impacts on coastal and terrestrial ecosystems. ZOE is
            the municipality's integrated response.
          </p>
        </div>
      </section>
