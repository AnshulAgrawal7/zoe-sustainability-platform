...
| P2 | Zentrale Kommunikation fehlt (nur FB-Profil Fr. Kokkali, erreicht nicht alle) | Ein zentraler Kommunikationsort für abgeschlossene + anstehende Projekte | `ProjectsPage` + `ProjectDetailPage` + Statusfilter (offen/abgeschlossen), persistente Navigation | DP1 | Simelio 2021 **[A]**, Lourenço 2023 **[B]** |
