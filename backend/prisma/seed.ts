...
async function main() {
  ...
  await Promise.all([
    makeEvent('evt-cleanup-jun25',
      ...
      '2026-07-16T09:00:00.000Z', 'Kassiopi Beach, North Corfu', 'MARINE_PROTECTION', 'proj-marine', 25, 80),
    makeEvent('evt-cleanup-jul25',
      ...
      '2026-07-19T09:00:00.000Z', 'Almyros Beach, North Corfu', 'MARINE_PROTECTION', 'proj-marine', 25, 60),
    makeEvent('evt-biodiversity-workshop',
      ...
      '2026-07-26T08:30:00.000Z', 'Antinioti Lagoon, NE Corfu', 'NATURAL_MONUMENTS', 'proj-antinioti', 20, 25),
    makeEvent('evt-recycling-hub',
      ...
      '2026-08-02T11:00:00.000Z', 'Municipal Hub, North Corfu', 'WASTE_CIRCULAR', 'proj-circular', 20, 150),
    makeEvent('evt-composting-expansion',
      ...
      '2026-08-23T18:30:00.000Z', 'Town Hall, North Corfu', 'WASTE_CIRCULAR', 'proj-circular', 20, 80),
    makeEvent('evt-water-monitoring',
      ...
      '2026-08-30T08:30:00.000Z', 'Acharavi, North Corfu', 'NATURAL_MONUMENTS', 'proj-water-quality', 30, 15),
    makeEvent('evt-reforestation-day',
      ...
      '2026-09-13T09:00:00.000Z', 'Nymfes, North Corfu', 'NATURAL_MONUMENTS', 'proj-natural-monuments', 25, 50,
    ...
    makeEvent('evt-youth-eco',
      ...
      '2026-09-20T09:00:00.000Z', 'Ionian University, Corfu', 'EDUCATION_PARTICIPATION', 'proj-education', 20, 30),
    makeEvent('evt-sdg-forum',
      ...
      '2026-09-27T09:00:00.000Z', 'Kassiopi Community Hall', 'EDUCATION_PARTICIPATION', 'proj-zoe-programme', 30, 200),
  ]);
  ...
  await Promise.all([
    makeLearn('learn-antinioti',
      ...
      'NATURAL_MONUMENTS', [15, 6, 14], 'proj-antinioti', 'EU Natura 2000 network'),
    makeLearn('learn-erimitis',
      ...
      'NATURAL_MONUMENTS', [15, 13], 'proj-natural-monuments'),
    makeLearn('learn-marine',
      ...
      'MARINE_PROTECTION', [14, 15], 'proj-marine', 'ARCHELON; ODEK Kerkyra'),
    makeLearn('learn-circular',
      ...
      'WASTE_CIRCULAR', [12, 11], 'proj-circular', 'Verde.tec 2026 / Attica Green Expo 2026'),
  ]);
